...
image=Image.open('C:\\Users\\Lenovo\\OneDrive\\Desktop\\Task1\\resources\\images\\Galaxy_stars.jpg')
st.image(image, caption="Stars in our Univrse",width=500)
df=pd.read_csv("C:\\Users\\Lenovo\\OneDrive\\Desktop\\Task1\\resources\\data\\stars.csv")
st.dataframe(df)
st.write(df.shape)
