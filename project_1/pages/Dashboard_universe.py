...
if option=='Sun':
    image1 = os.path.join(dir_of_interest, "images", "sun.jpg")
    img1=image.imread(image1)
    st.image(img1)
    ...
    image2 = os.path.join(dir_of_interest, "images", "Stephenson_2-18.webp")
    img2=image.imread(image2)
    st.image(img2)
    ...
    image3 = os.path.join(dir_of_interest, "images", "mercury.jpg")
    img3=image.imread(image3)
    st.image(img3)
    ...
    image4 = os.path.join(dir_of_interest, "images", "venus.jpg")
    img4=image.imread(image4)
    st.image(img4)
    ...
    image5 = os.path.join(dir_of_interest, "images", "mars.jpg")
    img5=image.imread(image5)
    st.image(img5)
    ...
    image6 = os.path.join(dir_of_interest, "images", "jupiter.jpg")
    img6=image.imread(image6)
    st.image(img6)
    ...
    image7 = os.path.join(dir_of_interest, "images", "saturn.jpg")
    img7=image.imread(image7)
    st.image(img7)
    ...
    image8 = os.path.join(dir_of_interest, "images", "uranus.jpg")
    img8=image.imread(image8)
    st.image(img8)
    ...
    image9 = os.path.join(dir_of_interest, "images", "neptune.jpg")
    img9=image.imread(image9)
    st.image(img9)
